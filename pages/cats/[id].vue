            ...
            <div class="p-6">
                ...
                <div class="mb-6">
                    ...
                    <div v-if="applicationsLoading" class="text-center py-4">
                        <div
                            class="inline-block animate-spin rounded-full h-6 w-6 border-b-2 border-blue-600"></div>
                    ...
                    <div v-else-if="applications.length > 0" class="space-y-3">
                        <div
                            ...
                            <div
                                class="grid grid-cols-1 md:grid-cols-2 gap-2 text-sm text-gray-600 mb-2">
                                ...
                                <div v-if="app.application_reason" class="md:col-span-2">
                                    <span class="font-medium">申请理由：</span
